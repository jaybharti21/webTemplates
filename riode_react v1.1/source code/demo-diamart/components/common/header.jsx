                ...
                <div className="container">
                    <div className="header-left">
                        <div className="welcome-msg">
                            <ALink href="/pages/contact-us" className="contact"><i className="d-icon-map"></i>Find Riode Store</ALink> <ALink href="#" className="help"><i className="d-icon-info"></i>Free Standard Shipping</ALink>
                        </div>
                    </div>
                    <div className="header-right">
                        <ALink className="call ls-m d-lg-show" href="tel:#">
