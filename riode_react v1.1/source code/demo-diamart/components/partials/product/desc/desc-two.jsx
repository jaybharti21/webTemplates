...
function DescTwo ( props ) {
    const { product, adClass = 'product-details', isSize = true, openModal } = props;
    let colors = [], sizes = [];
    ...
    return (
        <div className={ `${ adClass }` }>
            <Accordion adClass="accordion-simple mb-4">
                <Card title="Description" expanded={ true } adClass="border-no card-description">
                        ...
                        <div className="mb-4">
                            ...
                            <table className="table">
                                <tbody>
                                    ...
                                    <tr>
                                        <th className="font-weight-semi-bold text-dark pl-0">Recommended Use</th>
                                        <td className="pl-4">Praesent id enim sit amet.Tdio vulputate eleifend in in tortor. ellus massa. siti</td>
                                    </tr>
                                    <tr>
                                        <th className="font-weight-semi-bold text-dark border-no pl-0">Manufacturer</th>
                ...
                { isSize && <Card title="Size Guide" adClass="card-sizeguide">
...
export default connect( '', { openModal: modalActions.openModal } )( DescTwo )