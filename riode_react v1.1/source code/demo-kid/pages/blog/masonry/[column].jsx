    ...
    return (
        <main className="main skeleton-body">
            ...
            <div className="page-content pb-10 mb-10">
                <div className="container">
                    <ul className="nav-filters filter-underline blog-filters justify-content-center border-no">
                        <li><ALink href={ { pathname: `/blog/masonry/${ column }`, query: { category: '' } } } className={ `nav-filter ${ currentCategory === '' || currentCategory === null ? 'active' : '' } ` } scroll={ false }>All</ALink><span>17</span></li>
                        <li><ALink href={ { pathname: `/blog/masonry/${ column }`, query: { category: 'fashion' } } } className={ `nav-filter ${ currentCategory === 'fashion' ? 'active' : '' } ` } scroll={ false }>Fashion</ALink><span>12</span></li>
                        <li><ALink href={ { pathname: `/blog/masonry/${ column }`, query: { category: 'lifestyle' } } } className={ `nav-filter ${ currentCategory === 'lifestyle' ? 'active' : '' } ` } scroll={ false }>Lifestyle</ALink><span>13</span></li>
                        <li><ALink href={ { pathname: `/blog/masonry/${ column }`, query: { category: 'shopping' } } } className={ `nav-filter ${ currentCategory === 'shopping' ? 'active' : '' } ` } scroll={ false }>Shopping</ALink><span>1</span></li>
                        <li><ALink href={ { pathname: `/blog/masonry/${ column }`, query: { category: 'sport' } } } className={ `nav-filter ${ currentCategory === 'sport' ? 'active' : '' } ` } scroll={ false }>Sport</ALink><span>4</span></li>
                        <li><ALink href={ { pathname: `/blog/masonry/${ column }`, query: { category: 'summer-sale' } } } className={ `nav-filter ${ currentCategory === 'summer-sale' ? 'active' : '' } ` } scroll={ false }>Summer Sale</ALink><span>2</span></li>
                        ...
                        <li><ALink href={ { pathname: `/blog/masonry/${ column }`, query: { category: 'winter-sale' } } } className={ `nav-filter ${ currentCategory === 'winter-sale' ? 'active' : '' } ` } scroll={ false }>Winter Sale</ALink><span>2</span></li>
                    </ul>
