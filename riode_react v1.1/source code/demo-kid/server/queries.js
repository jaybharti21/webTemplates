...
export const GET_HOME_DATA = gql`
    query indexData($productsCount: Int, $postsCount: Int) {
        specialProducts(demo: ${currentDemo }, featured: true, bestSelling: true, latest: true, count: $productsCount) {
            featured {
                ...ProductSimple
            }
            bestSelling {
        ...
        clothings: products(demo: ${currentDemo }, category: "apparels-for-baby") {
            data {
                ...ProductSimple
            }
        }
        toys: products(demo: ${currentDemo }, category: "baby-toys") {
            data {
                ...ProductSimple
            }
        }
        foods: products(demo: ${currentDemo }, category: "milk-for-baby") {
            data {
                ...ProductSimple
            }
        }
