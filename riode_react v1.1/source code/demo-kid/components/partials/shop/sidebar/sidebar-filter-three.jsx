        ...
        <aside className="sidebar shop-sidebar sidebar-fixed">
            ...
            <div className="sidebar-content toolbox-left">
                ...
                <div className="toolbox-item select-menu">
                    <a className="select-menu-toggle" href="#" onClick={ selectOptionHandler }>By Age</a>
                    ...
                    <ul className="filter-items">
                        {
                            filterData.brands.map( ( item, index ) =>
                                <li
                                    ...
                                    onClick={ selectFilterHandler }
                                >
                                    <ALink href={ { pathname: router.pathname, query: { ...query, page: 1, brands: getUrlForAttrs( 'brands', item.slug ), type: router.query.type ? router.query.type : null } } } scroll={ false }>{ item.name }
                                    </ALink>
                                </li>
                            )
                        }
