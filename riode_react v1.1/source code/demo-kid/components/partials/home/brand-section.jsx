...
function BrandSection () {
    return (
        <Reveal keyframes={ fadeIn } duration={ 1200 } triggerOnce>
            <section className="brands mt-4 mb-5">
                <h2 className="title title-underline with-link"><span>From Our Brand</span></h2>

                <OwlCarousel adClass="owl-theme brand-carousel gutter-no" options={ brandSlider }>
                    <figure>
