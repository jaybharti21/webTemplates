...
function DescOne ( props ) {
    const { product, isGuide = true, isDivider = true, openModal, adClass = "" } = props;
    ...
    return (
        <Tabs className={ `tab tab-nav-simple product-tabs ${ adClass }` } selectedTabClassName="show" selectedTabPanelClassName="active" defaultIndex={ 0 } >
                ...
                <TabPanel className="tab-pane product-tab-description">
                    <div className="row mt-6">
                        ...
                        <div>
                            ...
                            <div className="d-flex justify-content-between flex-wrap pb-3" style={ { maxWidth: "55.3rem" } }>
                                <div className="icon-box icon-box-side icon-border pt-2 pb-2 mb-lg-4">
                                    <div className="icon-box-icon">
                                        <i className="d-icon-lock"></i>
                                    </div>
                                    <div className="icon-box-content">
                                        <h4 className="icon-box-title lh-1 pt-1 ls-s text-normal">2
                                        year
                                            warranty</h4>
                                ...
                                {
                                    isDivider ?
                                        <div className="divider d-lg-show"></div> : ''
                                }
                                <div className="icon-box icon-box-side icon-border pt-2 pb-2 mb-lg-4">
                                    <div className="icon-box-icon">
...

                {
                    ...
                    <TabPanel className="tab-pane product-tab-shipping-returns">
                        ...
                        ofthe delivery options we offer, please view our <ALink className="text-primary"
                                href="#">Deliveryinformation</ALink>We hope you’ll love everypurchase, but
                        if you
                        ever need to return an item you can do so within a month ofreceipt. For full
                        details
                        of how to make a return, please view our<ALink className="text-primary"
                                href="#">Returns
                            information</ALink></p>
                    </TabPanel>
                }
