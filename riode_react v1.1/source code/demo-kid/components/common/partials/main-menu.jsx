        ...
        <nav className="main-nav ml-4">
            <ul className="menu menu-active-underline">
                ...
                <li className={ `submenu  ${ pathname.includes( '/product' ) && !pathname.includes( '/elements' ) ? 'active' : '' }` }>
                    <ALink href="/product/default/anti-virus-ping-pang-sound">Products</ALink>

                    <div className="megamenu" style={ { marginLeft: "-130px" } }>
                        <div className="row">
                            <div className="col-6 col-sm-4 col-md-3 col-lg-4">
                ...
                <li className={ `${ pathname.includes( '/elements' ) ? 'active' : '' } submenu` }>
