    ...
    return (
        <footer className="footer">
                        ...
                        <div className="col-xl-3 col-lg-4 col-sm-6">
                            <div className="widget widget-about">
                                <ALink href="/" className="logo-footer mb-5">
                                    <img src="./images/home/logo-footer.png" alt="logo-footer" width="308" height="86" />
                                </ALink>
                                <div className="widget-body">
                                    <p className="ls-s">Fringilla urna porttitor rhoncus dolor purus<br />luctus venenatis lectus magna fringilla diam<br />maecenas ultricies mi eget mauris.</p>
            ...
            <div className="footer-bottom d-block text-center">
                <p className="copyright pl-1 pr-1">Riode eCommerce &copy; 2021. All Rights Reserved</p>
            </div>
        </footer>
    )
}