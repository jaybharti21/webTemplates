            ...
            <div className="container">
                <div className="footer-middle">
                    <div className="row">
                        <div className="col-lg-3 col-sm-6">
                            <div className="widget widget-about">
                                <ALink href="/" className="logo-footer">
                                    <img src="./images/home/logo-footer.png" alt="logo-footer" width="153" height="44" />
                                </ALink>
                                <div className="widget-contact-info widget-collapsible">
                                    <ul className="contact-info">
                                        <li className="info phone"><label>PHONE:</label><ALink href="tel:#" target="_blank">Toll
                                                Free (123) 456-7890</ALink></li>
                                        <li className="info email"><label>EMAIL:</label><ALink href="mailto:mail@Riode.com"
                                            target="_blank">mail@Riode.com</ALink></li>
                                        <li className="info addr"><label>ADDRESS:</label><ALink href="#">123 Street Name, City,
                                                England</ALink></li>
                                        <li className="info work"><label>WORKING DAYS / HOURS:</label><ALink href="#">Mon - Sun
                                        / 9:00 AM -
                                                8:00 PM</ALink></li>
                                    </ul>
                                </div>
                        ...
                        <div className="col-lg-3 col-sm-6">
                            <div className="widget widget-instagram mb-0">
