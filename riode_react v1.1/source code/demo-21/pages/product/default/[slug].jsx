...
function ProductDefault () {
    ...
    return (
        <main className="main pt-6 border-top single-product">
            <Helmet>
            ...
            {
                product !== undefined ?
                    <div className={ `page-content mb-10 pb-8 ${ loaded ? '' : 'd-none' }` }>
                        <div className="container skeleton-body">
                            <div className="product product-single row mb-2">
                                ...
                                <div className="col-md-6">
                                    <DetailThree data={ data } isSticky={ true } isSizeGuide={ false } isDesc={ true } />
                                </div>
                            </div>

                            <RelatedProducts products={ related } adClass="product-wrapper" />
                        </div>
                    </div> : ''
            }
            {
