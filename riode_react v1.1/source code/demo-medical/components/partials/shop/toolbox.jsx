...
export default function ToolBox ( props ) {
    ...
    const stickyToolboxHandler = ( e ) => {
        ...
        let top = document.querySelector( '.sticky-toolbox-wrapper' ) ? document.querySelector( '.sticky-toolbox-wrapper' ).offsetTop + document.querySelector( '.sticky-toolbox-wrapper' ).offsetHeight + 100 : 600;
        let height = 0;
