                                ...
                                <form action="#" className="form">
                                    <div className="row">
                                        <div className="col-lg-7 mb-6 mb-lg-0 pr-lg-4">
                                            <h3 className="title title-simple text-left text-uppercase pb-3">Billing Details</h3>
                                            <div className="row">
                                            ...
                                            <h2 className="title title-simple text-uppercase text-left mt-6 pb-3">Additional Information</h2>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr className="summary-total">
                                                                ...
                                                                <td className=" pt-0 pb-0">
                                                                    <p className="summary-total-price ls-s text-primary">$290.00</p>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
