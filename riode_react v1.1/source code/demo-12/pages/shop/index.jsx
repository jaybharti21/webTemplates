...
function ShopHorizontalFilter() {
    ...
    return (
        <main className="main">
            ...
            <div className="page-header" style={ { backgroundImage: `url(./images/home/page-header.jpg)` } }>
                <h1 className="page-title font-weight-bold">RIODE SHOP</h1>
                <h3 className="page-subtitle font-weight-normal">16 Products</h3>
            </div>
