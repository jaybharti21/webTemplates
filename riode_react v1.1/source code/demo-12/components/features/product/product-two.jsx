...
function ProductTwo( props ) {
    const { product, adClass = 'text-center', toggleWishlist, wishlist, addToCart, openQuickview, isCategory = true, showNew = true } = props;
        ...
        <div className={ `product text-left ${ adClass }` }>
            <figure className="product-media">
                ...
                <div className="product-label-group">
                    { product.is_new && showNew ? <label className="product-label label-new">New</label> : '' }
