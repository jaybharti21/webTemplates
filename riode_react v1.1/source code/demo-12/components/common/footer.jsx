                            ...
                            <div className="widget widget-about">
                                ...
                                <div className="widget-contact-info widget-collapsible">
                                    <ul className="contact-info">
                                        <li className="info phone"><label>PHONE:</label><a href="tel:#">Toll
                                                Free (123) 456-7890</a></li>
                                        <li className="info email"><label>EMAIL:</label><ALink href="mailto:riode@mail.com"
                                            target="_blank">riode@mail.com</ALink></li>
                                        <li className="info addr"><label>ADDRESS:</label><ALink href="#">123 Street, City,
                                                Country</ALink></li>
