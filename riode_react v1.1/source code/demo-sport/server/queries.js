...
export const currentDemo = `"sport"`;
...
export const GET_HOME_DATA = gql`
    query indexData($productsCount: Int) {
        specialProducts(demo: ${currentDemo }, featured: true, bestSelling: true, topRated: true, latest: true, count: $productsCount) {
            featured {
                ...ProductSimple
            }
            bestSelling {
        ...
        products(demo: ${ currentDemo }, to: 8) {
            data {
                ...ProductSimple
            }
            total
