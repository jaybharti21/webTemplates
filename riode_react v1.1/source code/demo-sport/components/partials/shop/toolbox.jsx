...
export default function ToolBox ( props ) {
    ...
    return (
        <nav className={ `toolbox sticky-toolbox sticky-content fix-top ${ type === "horizontal" ? 'toolbox-horizontal' : '' } ${ type === "boxed" ? "pt-4" : "" }` }>
            {
            ...
            <div className="toolbox-left">
                {
                    type === "left" || type === "off-canvas" || type === "navigation" || type === "horizontal" ?
                        <ALink href="#" className={ `toolbox-item left-sidebar-toggle btn btn-outline btn-rounded btn-sm ${ type === "navigation" ? "btn-dark btn-icon-left font-primary" : "btn-icon-right btn-primary" } ${ type === "off-canvas" || type === "navigation" ? '' : "d-lg-none" }` } onClick={ showSidebar }>
                            {
