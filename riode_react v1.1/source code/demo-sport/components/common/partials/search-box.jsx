...
function SearchForm ( props ) {
    ...
    return (
        <div className={ `header-search hs-toggle ${ adClass }` }>
            <a href="#" className="search-toggle d-inline-block" role="button" onClick={ onSearchClick }><i className="d-icon-search"></i></a>
