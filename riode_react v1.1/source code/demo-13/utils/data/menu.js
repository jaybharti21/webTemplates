        ...
        "pages": [
            {
                ...
                "url": "product/default/awesome-bag"
            },
            {
                "title": "Variable Product",
                "url": "product/default/blue-bright-table-lamp"
            },
            {
                "title": "Sale Product",
                "url": "product/default/nike-air-zoom-odyssey-2"
            },
            {
                "title": "Feature & On Sale",
                "url": "product/default/fashionable-brown-shoes"
            },
            {
                "title": "With Left Sidebar",
                "url": "product/left-sidebar/fashion-sports-bag"
            },
            {
                "title": "With Right Sidebar",
                "url": "product/right-sidebar/fashion-sports-bag"
            },
            {
                "title": "Add Cart Sticky",
                "url": "product/sticky-cart/fashion-sports-bag",
                "hot": true
            },
            {
                "title": "Tab Inside",
                "url": "product/tab-inside/fashion-sports-bag"
            }
        ],
        "layout": [
            {
                "title": "Grid Images",
                "url": "product/grid/fashion-sports-bag",
                "new": true
            },
            {
                "title": "Masonry",
                "url": "product/masonry/fashion-sports-bag"
            },
            {
                "title": "Gallery Type",
                "url": "product/gallery/fashion-sports-bag"
            },
            {
                "title": "Full Width Layout",
                "url": "product/full-width/fashion-sports-bag"
            },
            {
                "title": "Sticky Info",
                "url": "product/sticky-info/fashion-sports-bag"
            },
            {
                "title": "Left & Right Sticky",
                "url": "product/sticky-both/fashion-sports-bag"
            },
            {
                "title": "Horizontal Thumb",
                "url": "product/horizontal/fashion-sports-bag"
            },
            {
...
export const headerTransprentList = [
    "/shop/banner-sidebar",
    "/shop/boxed-banner",
    "/product/default/[slug]",
    "/product/left-sidebar/[slug]",
    "/product/right-sidebar/[slug]",
    "/product/sticky-cart/[slug]",
    "/product/tab-inside/[slug]",
    "/product/grid/[slug]",
    "/product/masonry/[slug]",
    "/product/gallery/[slug]",
    "/product/full-width/[slug]",
    "/product/sticky-info/[slug]",
    "/product/gallery/[slug]",
    "/product/sticky-both/[slug]",
    "/product/horizontal/[slug]",
    "/pages/account",
    "/pages/cart",
    "/pages/wishlist",
    "/pages/checkout",
