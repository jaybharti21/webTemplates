                    ...
                    <div className="row">
                        <div className="col-lg-3">
                            <ALink href="/" className="logo-footer">
                                <img src="./images/home/logo.png" alt="logo-footer" width="154" height="43" />
                            </ALink>
                        ...
                        <div className="col-lg-9">
                            <div className="widget widget-newsletter form-wrapper form-wrapper-inline">
                                ...
                                <form action="#" className="input-wrapper input-wrapper-inline">
                                    ...
                                    <button className="btn btn-rounded btn-primary btn-md ml-2" type="submit">subscribe<i
                        ...
                        <div className="col-lg-3 col-md-6">
                            <div className="widget ml-lg-4">
                                ...
                                <ul className="widget-body">
                                    ...
                                    <li>
                                        <ALink href="/pages/cart">My Wishlist</ALink>
                                    </li>
                                    <li>
