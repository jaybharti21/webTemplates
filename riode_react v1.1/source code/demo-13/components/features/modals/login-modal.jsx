...
function LoginModal() {
    ...
    return (
        <>
            <a className="login-link mr-lg-6 mr-sm-4 mr-2" href="#" onClick={ openModal }><i
                className="d-icon-user"></i></a>
            {
                open ?
                    <Modal
                        isOpen={ open }
                                            ...
                                            <form action="#">
                                                ...
                                                <div className="form-footer">
                                                    <div className="form-checkbox">
                                                        <input type="checkbox" className="custom-checkbox" id="signin-remember-login" name="signin-remember" />
                                                        <label className="form-control-label" htmlFor="signin-remember-login">Remember me</label>
                                                    </div>
