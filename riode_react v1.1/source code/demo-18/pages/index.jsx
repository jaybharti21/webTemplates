                        ...
                        <div className="col-lg-9">
                            ...
                            <section className="toolbox">
                                <div className="toolbox-left">
                                    {
                                        query.category ? <h2 className="title title-simple text-left">{ categoryList.findIndex( item => item.slug === query.category ) > -1 ? categoryList[ categoryList.findIndex( item => item.slug === query.category ) ].name : "Riode Shop" }</h2> : <h2 className="title title-simple text-left">Riode Shop</h2>
                                    }
                                    {
