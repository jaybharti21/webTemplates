...
function SearchForm () {
    ...
    return (
        <div className="header-search hs-toggle d-xl-show search-left">
            <ALink href="#" className="search-toggle mr-6 d-inline-block" role="button"><i className="d-icon-search"></i></ALink>
