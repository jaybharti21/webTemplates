                ...
                <div className="container">
                    <div className="header-left">
                        ...
                        <ALink href="/" className="logo mr-4">
                            <img src='./images/home/logo.png' alt="logo" width="153" height="43" />
                        </ALink>
                    </div>

                    <div className="header-center mr-xl-6 ml-xl-8">
                        <SearchBox />
                    </div>

                    <div className="header-right">
                        <ALink href="tel:#" className="icon-box icon-box-side mr-lg-3">
                        ...
                        <span className="divider"></span>
                        <a href="#" className="compare mr-xl-7 mr-4">
