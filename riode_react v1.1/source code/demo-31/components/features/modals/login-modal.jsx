...
function LoginModal() {
    ...
    return (
        <>
            <a className="login" href="#" onClick={openModal}>
                <i className="d-icon-user"></i></a>
                                            ...
                                            <form action="#">
                                                ...
                                                <div className="form-footer">
                                                    <div className="form-checkbox">
                                                        <input type="checkbox" className="custom-checkbox" id="signin-remember1" name="signin-remember" />
                                                        <label className="form-control-label" htmlFor="signin-remember1">Remember me</label>
                                                    </div>
