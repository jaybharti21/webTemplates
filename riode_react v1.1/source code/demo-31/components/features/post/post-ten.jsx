...
function PostTen(props) {
    ...
    return (
        <div className={`post overlay-dark ${post.type === 'video' ? 'post-video' : ''} ${adClass}`}>
            {
            ...
            <div className="post-details">
                ...
                <ALink href={`/blog/single/${post.slug}`} className={`btn btn-link btn-underline btn-primary btn-md ${btnAdClass}`}>{btnText}<i className="d-icon-arrow-right"></i></ALink>
            </div>
        </div >
    )
}
