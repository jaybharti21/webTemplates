            ...
            <div className="page-content pb-10 mb-10">
                <div className="container">
                    <ul className="nav-filters filter-underline blog-filters justify-content-center">
                        ...
                        <li><ALink href={{ pathname: `/blog/mask/masonry`, query: { category: 'fashion' } }} className={`nav-filter ${currentCategory === 'fashion' ? 'active' : ''} `} scroll={false}>Fashion</ALink><span>14</span></li>
                        <li><ALink href={{ pathname: `/blog/mask/masonry`, query: { category: 'lifestyle' } }} className={`nav-filter ${currentCategory === 'lifestyle' ? 'active' : ''} `} scroll={false}>Lifestyle</ALink><span>13</span></li>
                        <li><ALink href={{ pathname: `/blog/mask/masonry`, query: { category: 'shopping' } }} className={`nav-filter ${currentCategory === 'shopping' ? 'active' : ''} `} scroll={false}>Shopping</ALink><span>1</span></li>
                        <li><ALink href={{ pathname: `/blog/mask/masonry`, query: { category: 'sport' } }} className={`nav-filter ${currentCategory === 'sport' ? 'active' : ''} `} scroll={false}>Sport</ALink><span>1</span></li>
                        <li><ALink href={{ pathname: `/blog/mask/masonry`, query: { category: 'summer-sale' } }} className={`nav-filter ${currentCategory === 'summer-sale' ? 'active' : ''} `} scroll={false}>Summer Sale</ALink><span>2</span></li>
                        ...
                        <li><ALink href={{ pathname: `/blog/mask/masonry`, query: { category: 'winter-sale' } }} className={`nav-filter ${currentCategory === 'winter-sale' ? 'active' : ''} `} scroll={false}>Winter Sale</ALink><span>2</span></li>
                    </ul>
