...
export default function ShopBanner(props) {
    ...
    return (
        <div className="page-header" style={{ backgroundImage: `url( ./images/home/page-header-back.jpg )`, backgroundColor: "#3C63A4" }}>
            {
                subTitle ? <h3 className="page-subtitle">{subTitle}</h3> : ''
            }
            {
                title ? <h1 className="page-title ls-m mt-3">{title}</h1> : ''
            }
