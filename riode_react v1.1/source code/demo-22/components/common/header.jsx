            ...
            <div className="header-bottom has-dropdown pb-0">
                <div className="container d-flex align-items-center">
                    <div className="dropdown category-dropdown has-border fixed">
                        <ALink href="#" className="text-white font-weight-semi-bold category-toggle"><i className="d-icon-bars2"></i><span>Shop By Categories</span></ALink>
                        ...
                        <div className="dropdown-box">
                            <ul className="menu vertical-menu category-menu">
                                ...
                                <li className="submenu">
                                    <ALink href={ { pathname: '/shop', query: { category: 'electronics' } } }><i className="d-icon-camera1"></i>Electronics</ALink>
                                    <ul>
                                        ...
                                        <li><ALink href={ { pathname: '/shop', query: { category: 'video-recoders' } } }>Video Recorders</ALink></li>
                                    </ul>
                                </li>
                                <li>
                                ...
                                <li className="submenu">
                                    ...
                                    <ul>
                                        ...
                                        <li><ALink href={ { pathname: '/shop', query: { category: 'fashion-new-arrivals' } } }>New Arrivals</ALink></li>
                                        <li><ALink href={ { pathname: '/shop', query: { category: 'summer-dresses' } } }>Summer Dresses</ALink></li>
                                        <li><ALink href={ { pathname: '/shop', query: { category: 'sunglasses' } } }>Sunglasses</ALink></li>
                                    </ul>
                                </li>
                                <li className="submenu">
                                    <ALink href={ { pathname: '/shop', query: { category: 'computers' } } }><i className="d-icon-desktop"></i>Computers</ALink>
                                    <ul>
                                        ...
                                        <li><ALink href={ { pathname: '/shop', query: { category: 'storage-and-memory' } } }>Storage & Memory</ALink></li>
                                    </ul>
                                </li>
                                <li className="submenu">
                                    <ALink href={ { pathname: '/shop', query: { category: 'beauty-and-fragrance' } } }><i className="d-icon-heart"></i>Beauty &amp; Fragrance</ALink>
                                    ...
                                    <ul>
                                        ...
                                        <li><ALink href={ { pathname: '/shop', query: { category: 'tools-and-equipments' } } }>Tools &amp; Equipments</ALink></li>
                                    </ul>
                                </li>
                                <li>
                                ...
                                <li className="submenu">
                                    ...
                                    <ul>
                                        ...
                                        <li><ALink href={ { pathname: '/shop', query: { category: 'utensil-and-gadgets' } } }>Utensil &amp; Gadgets</ALink></li>
                                    </ul>
                                </li>
                                <li className="submenu">
