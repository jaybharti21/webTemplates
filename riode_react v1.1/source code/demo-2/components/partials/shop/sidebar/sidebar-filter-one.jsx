                        ...
                        <div className="sticky-sidebar">
                            {
                                type === "boxed" || type === "banner" ? '' :
                                    <div className="filter-actions mb-4">
                                        ...
                                        <ALink href={ { pathname: router.pathname, query: { grid: query.grid } } } scroll={ false } className="filter-clean">Clean All</ALink>
                                    </div>
                            }
                                    ...
                                    <ul className="widget-body filter-items">
                                        {
                                            filterData.sizes.map( ( item, index ) =>
                                                <li
                                                    ...
                                                    key={ item + ' - ' + index }
                                                >
                                                    <ALink scroll={ false } href={ { pathname: router.pathname, query: { ...query, page: 1, sizes: getUrlForAttrs( 'sizes', item.slug ) } } }>{ item.name }
                                                    </ALink>
                                                </li>
                                            )
                                        }
                                    ...
                                    <ul className="widget-body filter-items">
                                        {
                                            filterData.colors.map( ( item, index ) =>
                                                <li
                                                    ...
                                                    key={ item + ' - ' + index }
                                                >
                                                    <ALink scroll={ false } href={ { pathname: router.pathname, query: { ...query, page: 1, colors: getUrlForAttrs( 'colors', item.slug ) } } }>{ item.name }
                                                    </ALink>
                                                </li>
                                            )
                                        }
                                    ...
                                    <ul className="widget-body filter-items">
                                        {
                                            filterData.brands.map( ( item, index ) =>
                                                <li
                                                    ...
                                                    key={ item + ' - ' + index }
                                                >
                                                    <ALink scroll={ false } href={ { pathname: router.pathname, query: { ...query, page: 1, brands: getUrlForAttrs( 'brands', item.slug ) } } }>{ item.name }
                                                    </ALink>
                                                </li>
                                            )
                                        }
