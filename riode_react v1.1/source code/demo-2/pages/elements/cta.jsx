                            ...
                            <div className="col-md-6 mb-4">
                                <div className="banner banner-1 banner-fixed content-center content-middle">
                                    ...
                                    <div className="banner-content">
                                        <h3 className="banner-title text-uppercase font-weight-bold ls-m text-secondary">20%
                                            off</h3>
                        ...
                        <div className="container">
                            <div className="banner-content">
                                <h4 className="banner-subtitle text-white font-weight-bold ls-l">
                                    Extra<span className="d-inline-block label-star bg-dark text-secondary ml-4 mr-2">30%
                                        Off</span>Online
                                </h4>
