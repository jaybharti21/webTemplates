        ...
        <div className="dropdown cart-dropdown cart-offcanvas">
            <a href="#" className="cart-toggle" onClick={ showCartMenu }>
                <span className="cart-label d-lg-show">
                    <span className="cart-name">My cart</span> <span className="cart-name-delimiter">/</span> <span className="cart-price">${ toDecimal( getTotalPrice( cartList ) ) }</span>
                </span>
                <span className="cart-count">({ getCartCount( cartList ) } <span>Items</span>)</span>
            </a>
