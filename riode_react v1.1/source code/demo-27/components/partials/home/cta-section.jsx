...
function CtaSection () {
    ...
    return (
        <section className="banner banner-background parallax text-center" data-option="{'speed': 4}" style={ { backgroundImage: `url(./images/home/parallax.jpg)`, backgroundColor: "#313237" } }>
