                    ...
                    <ul className="filter-items filter-price">
                        {
                            prices.map((price, index) =>
                                <li
                                    ...
                                    onClick={selectFilterHandler}
                                >
                                    <ALink href={{ pathname: router.pathname, query: { ...query, page: 1, min_price: getUrlForAttrs('min_price', price.min), max_price: getUrlForAttrs('max_price', price.max), type: router.query.type ? { type: router.query.type } : null } }} scroll={false}>
                                        {
