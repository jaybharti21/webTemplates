...
function ProductTwo( props ) {
    const { product, adClass = 'text-center', toggleWishlist, wishlist, addToCart, openQuickview, newLabel = true } = props;
        ...
        <div className={ `product text-left ${ adClass }` }>
            <figure className="product-media">
                ...
                <div className="product-label-group">
                    { newLabel && product.is_new ? <label className="product-label label-new">New</label> : '' }
