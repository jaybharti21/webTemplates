...
function ProductSeven ( props ) {
    const { product, adClass = 'shadow-media', toggleWishlist, wishlist, addToCart, openQuickview, isRating = false } = props;
    ...
    return (
        <div className={ `product ${ product.variants.length > 0 ? 'product-variable' : '' } text-center product-with-qty ${ adClass }` }>
