...
export const GET_HOME_DATA = gql`
    query indexData($productsCount: Int) {
        specialProducts(demo: ${currentDemo }, featured: true, bestSelling: true, latest: true, topRated: true, count: $productsCount) {
            featured {
                ...ProductSimple
            }
            bestSelling {
        ...
        vegetables: products(demo: ${currentDemo }, category: "vegetables") {
            data {
                ...ProductSimple
            }
        }
