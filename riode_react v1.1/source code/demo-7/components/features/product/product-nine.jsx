...
function ProductNines( props ) {
    ...
    return (
        <div className={ `product text-left ${ adClass }` }>
            <figure className="product-media small-media">
            ...
            <div className="product-details">
                ...
                <div className="product-variations">
                    {
                        colors.map( ( item ) =>
                            <ALink className="color" href="#" style={ { backgroundColor: item.value } } key={ product.name + '-' + item.name }></ALink>
                        )
                    }
                </div>
            </div>
...
export default connect( mapStateToProps, { toggleWishlist: wishlistActions.toggleWishlist, addToCart: cartActions.addToCart, ...modalActions } )( ProductNines );