                    ...
                    <Tabs selectedTabClassName="active" selectedTabPanelClassName="active" defaultIndex={1}>
                        ...
                        <div className="tab-content w-100">
                            <TabPanel className="tab-pane fade">
                                ...
                                <li>
                                    <Card title="Products" type="mobile" url="/product/default/casual-pedistrian-shoes">
                                        <ul>
                                            <li>
                            ...
                            <TabPanel className="tab-pane fade">
                                <li><ALink href={{ pathname: "/shop", query: { category: "accessories" } }}>Get Free Riode Gifts!</ALink></li>
                                <li><ALink href={{ pathname: "/shop", query: { category: "electronics" } }}>Coupon Rain</ALink></li>
                                <li><ALink href={{ pathname: "/shop", query: { category: "fashion-shoes" } }}>Black Friday Deals</ALink></li>
                                <li><ALink href={{ pathname: "/shop", query: { category: "shop-electric" } }}>48H Only Lighting Deals</ALink></li>
                                <li><ALink href={{ pathname: "/shop", query: { category: "shop-women" } }}>Brand Sale</ALink></li>
                                <li><ALink href={{ pathname: "/shop", query: { category: "shop-men" } }}>Cool Man Fashion</ALink></li>
                                <li><ALink href={{ pathname: "/shop", query: { category: "uncategorized" } }}>Under $25</ALink></li>
                            </TabPanel>
                        </div>
                    </Tabs>
                </ul>
