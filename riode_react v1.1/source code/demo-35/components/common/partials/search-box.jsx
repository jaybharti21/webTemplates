...
function SearchForm(props) {
    ...
    return (
        <div className={`header-search hs-toggle ${mobile ? 'mobile-search d-block d-lg-none' : 'search-left'}`}>
            <a href="#" className={`search-toggle ${mobile ? 'text-white' : 'd-flex align-items-center'}`} role="button" onClick={onSearchClick}>
