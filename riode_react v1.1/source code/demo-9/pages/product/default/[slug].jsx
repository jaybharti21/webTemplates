...
import DetailTwo from '~/components/partials/product/detail/detail-two';
...
function ProductDefault() {
    ...
    return (
        <main className="main mt-lg-6 single-product">
            <Helmet>
                    ...
                    <div className={ `page-content mb-10 pb-4 ${ loaded ? '' : 'd-none' }` } >
                        <div className="container vertical">
                            <div className="product product-single row mb-4">
                                <div className="col-md-6 sticky-sidebar-wrapper mb-4 mb-lg-0">
                            ...
                            <RelatedProducts products={ related } adClass="pb-6 pt-10 mt-lg-6" />
                        </div>
                    </div> : ''
            }
            {
