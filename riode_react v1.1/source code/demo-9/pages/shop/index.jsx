...
function Shop() {
    ...
    return (
        <main className="main mt-lg-4">
            ...
            <div className="page-header" style={ { backgroundImage: `url(./images/home/page-header.jpg)`, backgroundColor: "#E4EAEA" } }>
                < h1 className="page-title ls-m font-weight-bold" > Riode Shop</h1>
                <h3 className="page-subtitle text-uppercase text-white font-weight-normal">16 Products</h3>
            </div>
