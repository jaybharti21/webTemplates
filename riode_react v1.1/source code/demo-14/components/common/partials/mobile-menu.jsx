...
import { mainMenu, headerCategories } from '~/utils/data/menu';
    ...
    return (
        <div className="mobile-menu-wrapper">
            ...
            <div className="mobile-menu-container scrollable">
                ...
                <Tabs className="tab tab-nav-simple tab-nav-boxed form-tab mt-6" selectedTabClassName="show" selectedTabPanelClassName="active">
                    <TabList className="nav nav-tabs nav-fill" role="tablist">
                        <Tab className="nav-item">
                            <span className="nav-link" href="#menu">Main Menu</span>
                        </Tab>
                        <Tab className="nav-item">
                            <span className="nav-link" href="#categories">Categories</span>
                        </Tab>
                    </TabList>
                    ...
                    <div className="tab-content">
                        <TabPanel className="tab-pane">
                            <ul className="mobile-menu mmenu-anim">
                                ...
                                <li>
                                    <Card title="Products" type="mobile" url="/product/default/most-attractive-roller-skate">
                                        <ul>
                                            <li>
                            ...
                            <ul className="mobile-menu mmenu-anim">
                                {
                                    headerCategories.map( cat =>
                                        <li key={ 'header-cat-' + cat.slug } className={ cat.slug === router.query.category ? 'active' : '' } onClick={ hideMobileMenu }>
