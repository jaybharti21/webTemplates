                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-9">
                            <div className="widget widget-newsletter form-wrapper form-wrapper-inline">
                                <div className="newsletter-info ml-lg-4 mx-auto">
                                ...
                                <form action="#" className="input-wrapper input-wrapper-inline">
                                    <input type="email" className="form-control" name="email" id="f-email"
                    ...
                    <div className="row">
                        <div className="col-lg-3 col-md-6">
                            <div className="widget widget-contact">
                                <h4 className="widget-title ls-normal">Contact Info</h4>
