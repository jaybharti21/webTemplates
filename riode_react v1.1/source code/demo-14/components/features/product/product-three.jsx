...
function ProductThree( props ) {
    const { product, adClass, toggleWishlist, wishlist, addToCart, openQuickview, isCategory = true, showNew = true } = props;
        ...
        <div className={ `product product-classic ${ adClass } ${ product.variants.length > 0 ? 'product-variable' : '' }` }>
            <figure className="product-media">
                ...
                <div className="product-label-group">
                    { showNew && product.is_new ? <label className="product-label label-new">New</label> : '' }
