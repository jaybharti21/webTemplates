...
import { GET_PRODUCT, GET_HOME_DATA } from '~/server/queries';
...
function ProductDefault() {
    ...
    const { data: homeData } = useQuery( GET_HOME_DATA, { variables: { productsCount: 3 } } );
    const [ loaded, setLoadingState ] = useState( false );
    const product = data && data.product.data;
    const related = data && data.product.related;
    const posts = homeData && homeData.posts.data;
    ...
    return (
        <main className="main mt-6 single-product home">
            <Helmet>
            ...
            {
                loaded && !loading ? ''
                    : <div className="skeleton-body container mb-10 pb-6">
                        <div className="row mb-10 pb-2">
                            <div className="col-xl-3 col-lg-4 sidebar sidebar-fixed sticky-sidebar-wrapper home-sidebar d-lg-show">
