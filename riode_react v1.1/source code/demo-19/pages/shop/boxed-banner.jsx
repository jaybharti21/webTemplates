    ...
    return (
        <main className="main border-top">
            ...
            <div className="page-content mb-10 pb-3">
                <div className="container">
                    <div className="shop-boxed-banner banner" style={ { backgroundImage: "url('./images/shop/banner2.jpg')", backgroundColor: "#f2f2f3" } }>
                    ...
                    <div className="row gutter-lg">
                        ...
                        <div className="col-lg-9">
                            <ProductListOne type="boxed" itemsPerRow={ 3 } />
                        </div>
                    </div>
                </div>
            </div>
