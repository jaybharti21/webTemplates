        ...
        <nav className="main-nav">
            <ul className="menu">
                ...
                <li className={`submenu lg-menu ${pathname.includes('/product') && !pathname.includes('/elements') ? 'active' : ''}`}>
                    <ALink href="/product/default/fashionable-overnight-bag">Products</ALink>
                ...
                <li className={`submenu lg-menu ${pathname.includes('/blog') && !pathname.includes('/elements') ? 'active' : ''}`}>
