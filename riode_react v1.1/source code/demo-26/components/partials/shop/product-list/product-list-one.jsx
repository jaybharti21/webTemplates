    ...
    return (
        <>
            ...
            }
            {
                loading ?
                    gridType === 'grid' ?
                        <div className={ `row product-wrapper ${ adClass } ${ gridClasses[ itemsPerRow ] }` }>
                            {
                    ...
                    <div className={ `row product-wrapper ${ gridClasses[ itemsPerRow ] }` }>
                        { products && products.map( item =>
                            <div className="product-wrap" key={ 'shop-' + item.slug }>
                                <ProductTwo product={ item } adClass="product-image-gap text-center" />
                            </div>
                        ) }
                    </div>
                    :
            ...
            {
                data && totalPage > 1 ?
                    <div className="toolbox toolbox-pagination mb-0">
                        {
