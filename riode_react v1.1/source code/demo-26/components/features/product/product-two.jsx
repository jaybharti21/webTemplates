...
function ProductTwo ( props ) {
    const { product, adClass = 'text-center', toggleWishlist, wishlist, addToCart, openQuickview, isCat = true, isBadge = true } = props;
        ...
        <div className={ `product ${ adClass }` }>
            <figure className="product-media">
                ...
                <div className="product-label-group">
                    { product.is_new && isBadge ? <label className="product-label label-new">New</label> : '' }
