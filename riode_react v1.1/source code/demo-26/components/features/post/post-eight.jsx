...
function PostEight ( props ) {
    const { post, adClass = 'post-frame mb-7', isLazy = false, isOriginal = false, btnText = "Read more", btnAdClass = '' } = props;
    const months = [ "JAN", "FEB", "MAR", "APR", "MAY", "JUN", "JUL", "AUG", "SEP", "OCT", "NOV", "DEC" ];

    return (
        <div className={ `post ${ post.type === 'video' ? 'post-video' : '' } ${ adClass }` }>
            {
