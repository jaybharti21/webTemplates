                    ...
                    isShipping ?
                        <TabPanel className="tab-pane product-tab-shipping-guide">
                            ...
                            <p className="mb-0">We deliver to over 100 countries around the world. For full
                                details of the delivery options we offer, please view our <ALink href="#" className="text-primary">Delivery information</ALink><br />We hope you’ll love
                                ...
                                our <br /><ALink href="#" className="text-primary">Returns information</ALink></p>
                        </TabPanel>
                        : ''
                }
