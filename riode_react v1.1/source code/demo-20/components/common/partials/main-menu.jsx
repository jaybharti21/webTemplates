        ...
        <nav className="main-nav mr-4">
            <ul className="menu menu-active-underline">
                ...
                <li className={ `submenu  ${ pathname.includes( '/shop' ) ? 'active' : '' }` }>
                    ...
                    <div className="megamenu" style={ { marginLeft: "-84px" } }>
                        <div className="row">
                ...
                <li className={ `submenu  ${ pathname.includes( '/product' ) && !pathname.includes( '/elements' ) ? 'active' : '' }` }>
                    <ALink href="/product/default/women-s-classic-backpack">Products</ALink>

                    <div className="megamenu" style={ { marginLeft: "-210px" } }>
                        <div className="row">
                            <div className="col-6 col-sm-4 col-md-3 col-lg-4">
                ...
                <li className={ `submenu  ${ pathname.includes( '/pages' ) && !pathname.includes( 'about-us' ) ? 'active' : '' }` }>
