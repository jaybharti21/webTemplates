                    ...
                    <div className="banner-content y-50" style={ { transformOrigin: "25%" } }>
                        <Reveal keyframes={ blurIn } delay={ 200 } duration={ 1200 } triggerOnce>
                            <>
                                ...
                                <ALink href="/shop" className="btn btn-white btn-link pb-2 pt-2 d-inline-block btn-infinite btn-slide-right">Shop now <i className="d-icon-arrow-right"></i></ALink>
                            </>
                        </Reveal>
                    </div>
                </div>
