        ...
        <nav className="main-nav mr-4">
            <ul className="menu menu-active-underline">
                ...
                <li className={ `submenu ${ pathname.includes( '/product' ) && !pathname.includes( '/elements' ) ? 'active' : '' }` }>
                    <ALink href="/product/default/pretty-lady-cosmetia">Products</ALink>

                    <div className="megamenu" style={ { marginLeft: "-200px" } }>
                        <div className="row">
                            <div className="col-6 col-sm-4 col-md-3 col-lg-4">
                ...
                <li className={ `submenu blog-menu ${ pathname.includes( '/blog' ) && !pathname.includes( '/elements' ) ? 'active' : '' }` }>
                ...
                <li className={ `submenu ${ pathname.includes( '/elements' ) ? 'active' : '' }` }>
