...
function DetailOne ( props ) {
    ...
    return (
        <div className={ `product-details ${ isSticky ? 'sticky' : '' } ${ adClass }` }>
            { isNav && <div className="product-navigation">
            ...
            <div className="product-form product-qty pb-0">
                ...
                <div className="product-form-group">
                    ...
                    <button className={ `btn-product btn-cart ${ cartActive ? '' : 'disabled' }` } onClick={ addToCartHandler }><i className='d-icon-bag'></i>Add to Cart</button>
                </div>
            </div>
            ...
            <div className="product-footer">
                ...
                </div> <span className="divider d-lg-show"></span>
            ...
            {
                isDesc ? <DescTwo product={ product.data } isGuide={ false } adClass={ adClass } /> : ''
            }
        </div >
    )
}
