            ...
            <div className="page-content pb-10 mb-10">
                <div className="container">
                    <ul className="nav-filters filter-underline blog-filters justify-content-center border-no">
                        ...
                        <li><ALink href={ { pathname: `/blog/mask/grid`, query: { category: 'fashion' } } } className={ `nav-filter ${ currentCategory === 'fashion' ? 'active' : '' }` } scroll={ false }>Fashion</ALink><span>13</span></li>
                        ...
                        <li><ALink href={ { pathname: `/blog/mask/grid`, query: { category: 'summer-sale' } } } className={ `nav-filter ${ currentCategory === 'summer-sale' ? 'active' : '' }` } scroll={ false }>Summer Sale</ALink><span>3</span></li>
                        ...
                        <li><ALink href={ { pathname: `/blog/mask/grid`, query: { category: 'winter-sale' } } } className={ `nav-filter ${ currentCategory === 'winter-sale' ? 'active' : '' }` } scroll={ false }>Winter Sale</ALink><span>3</span></li>
                    </ul>
