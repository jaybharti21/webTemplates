...
function ProductDefault () {
    ...
    return (
        <main className="main mt-6 single-product default-product">
            <Helmet>
                ...
                product !== undefined ?
                    <div className={ `page-content mb-10 pb-6 ${ loaded ? '' : 'd-none' }` }>
                        <div className="container skeleton-body vertical">
                            <div className="product product-single row mb-0">
                            ...
                            <DescOne adClass={ "mb-4" } product={ product } isGuide={ false } />
