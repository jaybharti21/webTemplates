...
function HomePage () {
    ...
    const best = data && data.specialProducts.bestSelling;
    const recent = data && data.specialProducts.latest;
    ...
    return (
        <div className="main home">
            ...
            <div className="page-content">
                ...
                <BestCollection products={ best } loading={ loading } />

                <CategorySection />

                <RecentCollection products={ recent } loading={ loading } />
