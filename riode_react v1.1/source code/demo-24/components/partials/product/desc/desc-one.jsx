...
function DescOne ( props ) {
    const { product, isGuide = true, isDivider = true, openModal, isShipping = false, isAdditional = true } = props;
                    ...
                    isShipping ?
                        <TabPanel className="tab-pane product-tab-shipping">
                            ...
                            <p className="mb-0">We deliver to over 100 countries around the world. For full
									details of the delivery options we offer, please view our <ALink href="#" className="text-primary">Delivery information</ALink><br />We hope you’ll
                        ...
                        so within a month of receipt. For full details of how to make a return,
									please view our <ALink href="#" className="text-primary">Returns information</ALink>
                            </p>
                        </TabPanel> : ''
                }
