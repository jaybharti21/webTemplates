...
function SearchForm () {
    ...
    return (
        <div className="header-search hs-toggle search-left">
            <ALink href="#" className="search-toggle d-flex align-items-center" role="button"><i className="d-icon-search"></i><span className="ml-1 text-uppercase">Search</span></ALink>
