            ...
            <div className="col-lg-9 mb-4">
                <OwlCarousel adClass="owl-theme owl-dot-inner intro-slider animation-slider" options={ introSlider }>
                    <div className="banner banner-fixed content-middle intro-slide intro-slide1 banner-radius" style={ { backgroundColor: "#f8f8f8" } }>
                        ...
                        <div className="banner-content">
                            <Reveal keyframes={ fadeInLeftShorter } duration={ 1000 }>
                                <h5 className="banner-subtitle text-capitalize font-weight-normal">Lifestyle Collection</h5>
                                <h3 className="banner-title text-uppercase font-weight-bold ls-m">for Ski Clothes</h3>
                    ...
                    <div className="banner banner-fixed content-middle intro-slide intro-slide2 banner-radius" style={ { backgroundColor: "#e2e2e3" } }>
                        ...
                        <div className="banner-content text-right">
                            <Reveal keyframes={ fadeInRightShorter } duration={ 1000 }>
                                <h5 className="banner-subtitle text-capitalize font-weight-normal">Find Your Trending</h5>
                                <h3 className="banner-title text-uppercase font-weight-bold ls-m">Autumn style</h3>
                                ...
                                <p className="text-dark font-weight-normal">* Only until the end of this week</p>
                                <ALink href="/shop" className="btn btn-dark btn-outline btn-rounded">
                                    Shop Now<i className="d-icon-arrow-right"></i></ALink>
                            </Reveal>
                        </div>
                    ...
                    <div className="banner banner-fixed content-middle intro-slide intro-slide3 banner-radius" style={ { backgroundColor: "#d8dee4" } }>
                        ...
                        <div className="banner-content">
                            <Reveal keyframes={ fadeInLeftShorter } duration={ 1000 }>
                                <h5 className="banner-subtitle text-capitalize font-weight-normal mb-1">Must-Haves</h5>
                                <h3 className="banner-title text-uppercase font-weight-bold ls-m">for the season</h3>
                                <div className="banner-price-info font-weight-semi-bold text-dark text-uppercase ls-m">
                                    Start At <span className="text-primary">$230.00</span>
                                </div>
                                <p className="text-dark font-weight-normal">* Get Plus Discount Buying Fashion</p>
                ...
                <div className="row cols-lg-1 cols-sm-2 cols-1">
                    <div className="intro-banner mb-4">
                        <div className="banner banner-fixed content-middle banner-radius overlay-zoom" style={ { backgroundColor: "#232323" } }>
                            ...
                            <div className="banner-content">
                                <h3 className="banner-title font-weight-bold text-white ls-m">Electronics</h3>
                                <div className="product-count text-uppercase text-white font-weight-semi-bold">23 Products</div>
                    ...
                    <div className="intro-banner mb-4">
                        <div className="banner banner-fixed content-middle banner-radius overlay-zoom" style={ { backgroundColor: "#eca5a9" } }>
                            ...
                            <div className="banner-content">
                                <h3 className="banner-title font-weight-bold text-white ls-m">Accessories</h3>
                                <div className="product-count text-uppercase text-white font-weight-semi-bold">28 Products</div>
                                <span className="divider bg-white"></span>
