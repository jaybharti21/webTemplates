            ...
            <div className="sidebar-content pb-0 pb-lg-4">
                <div>
                    <div className="filter-actions">
                        <a href="#" className="sidebar-toggle-btn toggle-remain btn btn-sm btn-outline btn-primary" onClick={ toggleSidebar }>
                            Filter<i className="d-icon-arrow-left"></i>
                        </a>
                        <ALink href={ { pathname: router.pathname, query: { type: router.query.type ? router.query.type : null  } } } className="filter-clean text-primary" scroll={ false } style={ { opacity: 1 } }>Clean All</ALink>
                    </div>
