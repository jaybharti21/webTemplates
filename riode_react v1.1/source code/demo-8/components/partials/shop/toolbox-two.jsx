...
export default function ToolBoxTwo( props ) {
            ...
            <div className="toolbox-left">
                {
                    type === "left" || type === "off-canvas" || type === "navigation" || type === "horizontal" ?
                        <ALink href="#" className={ `toolbox-item shop-toolbox-item  left-sidebar-toggle btn btn-outline btn-primary font-primary ${ type === "navigation" ? "btn-icon-left btn-sm" : "btn-sm btn-icon-right" } ${ type === "off-canvas" || type === "navigation" ? '' : "d-lg-none" }` } onClick={ showSidebar }>
                            {
                ...
                <p className="toolbox-item show-info mr-sm-auto">Showing <span> 12 of { props.totalCount } </span> Products</p>
            </div>
