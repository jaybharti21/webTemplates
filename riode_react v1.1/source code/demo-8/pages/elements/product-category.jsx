                        ...
                        <div className="row">
                            <div className="col-sm-6 col-lg-3 mb-4">
                                <div className="category category-default category-absolute overlay-zoom">
                                    ...
                                    <div className="category-content">
                                        <h4 className="category-name"><ALink href={ { pathname: '/shop', query: { category: 'for-men-s' } } }>For Men's</ALink></h4>
                            ...
                            <div className="col-sm-6 col-lg-3 mb-4">
                                <div className="category category-default category-absolute overlay-zoom">
                                    ...
                                    <div className="category-content">
                                        <h4 className="category-name"><ALink href={ { pathname: '/shop', query: { category: 'fashionable-women-s' } } }>Fashionable Women's</ALink></h4>
                                        <ALink href="#" className="btn btn-primary">Shop Now</ALink>
                                    </div>
                                </div>
                            </div>
                            <div className="col-sm-6 col-lg-3 mb-4">
                                <div className="category category-default category-absolute overlay-zoom">
                                    ...
                                    <div className="category-content">
                                        <h4 className="category-name"><ALink href={ { pathname: '/shop', query: { category: 'cosmetic' } } }>Cosmetic</ALink></h4>
                                        <ALink href="#" className="btn btn-primary">Shop Now</ALink>
                                    </div>
                                </div>
                            </div>
