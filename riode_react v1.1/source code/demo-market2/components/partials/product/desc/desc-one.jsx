                ...
                <TabPanel className="tab-pane product-tab-description">
                    <div className="row mt-6">
                        <div className="col-12">
                            <h5 className="description-title mb-4 font-weight-semi-bold ls-m">Features
                            </h5>
                            <p className="mb-2">
                ...
                }
                {
                    isGuide ?
                        <TabPanel className="tab-pane product-tab-size-guide">
                            <p className="mb-0">We deliver to over 100 countries around the world. For full details ofthe delivery options we offer, please view our <ALink className="text-primary" href="#">Deliveryinformation</ALink> We hope you’ll love everypurchase, but if you ever need to return an item you can do so within a month ofreceipt. For full details of how to make a return, please view our <ALink className="text-primary" href="#">Returns information</ALink></p>
                        </TabPanel> : ''
                }
