...
function ProductsSidebar ( props ) {
    const { adClass = 'col-lg-3', type = "right" } = props;
    ...
    return (
        <aside className={ `sidebar sidebar-fixed sticky-sidebar-wrapper ${ adClass } ${ type === 'left' ? '' : 'right-sidebar' }` }>
                                            ...
                                            <div className="overflow-hidden" ref={ setCollapsibleElement }>
                                                <ul className="widget-body filter-items">
                                                    <li className="store-name">
                                                        <span>Store Name:</span><span className="details">Vendor</span>
                                                    </li>
                                                    <li className="seller-name">
                                                        <span>Vendor:</span><span className="details">John Doe</span>
                                                    </li>
                                                    <li className="store-address">
                                                        <span>Address:</span><span className="details">CA</span>
                                                    </li>
                                        ...
                                        <div className="products-col">
                                            {
                                                featured.slice( 0, 3 ).map( ( product, index ) => (
                                                    <SmallProduct product={ product } key={ "small-product-" + index } adClass="text-center" isReviewCount={ false } />
                                                ) )
                                            }
                                        </div>
