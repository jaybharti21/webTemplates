...
export default function ToolBox ( props ) {
    ...
    const stickyToolboxHandler = ( e ) => {
        ...
        let top = document.querySelector( '.sticky-toolbox-wrapper' ) ? document.querySelector( '.sticky-toolbox-wrapper' ).offsetTop + document.querySelector( '.sticky-toolbox-wrapper' ).offsetHeight + 200 : 600;
        let height = 0;
    ...
    return (
        <nav className={ `toolbox sticky-toolbox sticky-content fix-top ${ type === "boxed" ? "pt-4" : "pt-2" } ${ type === "horizontal" ? 'toolbox-horizontal' : '' }` }>
            {
