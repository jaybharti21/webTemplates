...
export const currentDemo = `"market2"`;
...
export const GET_HOME_DATA = gql`
    query indexData($productsCount: Int) {
        specialProducts(demo: ${currentDemo },  featured: true, bestSelling: true, onSale: true, latest: true, topRated: true, count: $productsCount) {
            featured {
                ...ProductSimple
            }
            bestSelling {
