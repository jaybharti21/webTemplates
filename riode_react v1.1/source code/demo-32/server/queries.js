...
export const GET_HOME_DATA = gql`
    query indexData($productsCount: Int, $postsCount: Int, $category: String, $from: Int = 5, $to: Int = 30, $list: Boolean = false) {
        ...
        products(demo: ${currentDemo}, category: $category, from: $from, to: $to ) {
            data {
                short_description @include(if: $list)
                ...ProductSimple
