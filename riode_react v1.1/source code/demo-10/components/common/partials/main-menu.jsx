        ...
        <nav className="main-nav mr-0">
            <ul className="menu">
                ...
                <li className={ `submenu  ${ pathname.includes( '/product' ) && !pathname.includes( '/elements' ) ? 'active' : '' }` }>
                    <ALink href="/product/default/black-comfort-shoes">Products</ALink>
                ...
                <li className={ `submenu d-xl-show ${ pathname.includes( '/blog' ) && !pathname.includes( '/elements' ) ? 'active' : '' }` }>
