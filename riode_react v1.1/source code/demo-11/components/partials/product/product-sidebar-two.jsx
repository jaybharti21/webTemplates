...
function ProductsSidebar( props ) {
    ...
    return (
        <StickyBox offsetTop={ 88 } className="product-sidebar-wrapper">
                        ...
                        <div className="sticky-sidebar">
                            <div className="service-list mb-4">
                                ...
                                <div className="icon-box icon-box-side icon-box2">
                                    ...
                                    <div className="icon-box-content">
                                        <h4 className="icon-box-title ls-m">Money Back guarantee</h4>
                            ...
                            <div className="banner banner-fixed mb-7">
                                <figure>
                                    <LazyLoadImage src="./images/product-banner.jpg" width="280" height="312"
                                        alt="banner" />
                                </figure>
                                <div className="banner-content mt-1 text-center">
                            ...
                            <div className="widget widget-products">
                                <h4 className="widget-title border-no text-normal mb-0">Our Featured</h4>
