            ...
            <div className="page-content pb-10 mb-10">
                <div className="container">
                    <ul className="nav-filters filter-underline blog-filters justify-content-center">
                        <li><ALink href={ { pathname: `/blog/mask/masonry`, query: { category: '' } } } className={ `nav-filter ${ currentCategory === '' || currentCategory === null ? 'active' : '' } ` } scroll={ false }>All</ALink><span>19</span></li>
                        <li><ALink href={ { pathname: `/blog/mask/masonry`, query: { category: 'fashion' } } } className={ `nav-filter ${ currentCategory === 'fashion' ? 'active' : '' } ` } scroll={ false }>Fashion</ALink><span>12</span></li>
                        <li><ALink href={ { pathname: `/blog/mask/masonry`, query: { category: 'lifestyle' } } } className={ `nav-filter ${ currentCategory === 'lifestyle' ? 'active' : '' } ` } scroll={ false }>Lifestyle</ALink><span>12</span></li>
                        ...
                        <li><ALink href={ { pathname: `/blog/mask/masonry`, query: { category: 'sport' } } } className={ `nav-filter ${ currentCategory === 'sport' ? 'active' : '' } ` } scroll={ false }>Sport</ALink><span>6</span></li>
                        ...
                        <li><ALink href={ { pathname: `/blog/mask/masonry`, query: { category: 'travel' } } } className={ `nav-filter ${ currentCategory === 'travel' ? 'active' : '' } ` } scroll={ false }>Travel</ALink><span>5</span></li>
