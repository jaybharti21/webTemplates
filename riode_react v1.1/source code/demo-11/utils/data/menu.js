        ...
        "pages": [
            {
                ...
                "url": "product/default/beyond-light-shoes"
            },
            {
                "title": "Variable Product",
                "url": "product/default/cavin-brown-leather-ball"
            },
            {
                "title": "Sale Product",
                "url": "product/default/women-s-fashion-perfume"
            },
            {
                "title": "Feature & On Sale",
                "url": "product/default/circled-portable-speaker"
            },
            {
                "title": "With Left Sidebar",
                "url": "product/left-sidebar/kelvin-multi-functional-recorder"
            },
            {
                "title": "With Right Sidebar",
                "url": "product/right-sidebar/kelvin-multi-functional-recorder"
            },
            {
                "title": "Add Cart Sticky",
                "url": "product/sticky-cart/kelvin-multi-functional-recorder",
                "hot": true
            },
            {
                "title": "Tab Inside",
                "url": "product/tab-inside/kelvin-multi-functional-recorder"
            }
        ],
        "layout": [
            {
                "title": "Grid Images",
                "url": "product/grid/kelvin-multi-functional-recorder",
                "new": true
            },
            {
                "title": "Masonry",
                "url": "product/masonry/kelvin-multi-functional-recorder"
            },
            {
                "title": "Gallery Type",
                "url": "product/gallery/kelvin-multi-functional-recorder"
            },
            {
                "title": "Full Width Layout",
                "url": "product/full-width/kelvin-multi-functional-recorder"
            },
            {
                "title": "Sticky Info",
                "url": "product/sticky-info/kelvin-multi-functional-recorder"
            },
            {
                "title": "Left & Right Sticky",
                "url": "product/sticky-both/kelvin-multi-functional-recorder"
            },
            {
                "title": "Horizontal Thumb",
                "url": "product/horizontal/kelvin-multi-functional-recorder"
            },
            {
...
export const headerCategories = [
    ...
    {
        title: "Winter Sports Clothing",
        slug: "winter-sports-clothing"
    },
    {
        title: "Home & Kitchen",
    ...
    {
        title: "Riode Gift Card",
        slug: "riode-gift-card"
    }
]
